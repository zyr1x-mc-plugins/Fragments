...
public class FragmentsLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder classpathBuilder) {
        ...
        // Библиотеки, сгенерированные Gradle-плагином из library(...) в build.gradle.kts
        ...
        // Дополнительные репозитории и зависимости, не покрытые generateLibrariesJson
